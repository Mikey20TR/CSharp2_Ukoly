namespace Lekce3_BreakOut2
{
    public class Program
    {
        public static void Main()
        {
            ...
            int padding = 45;
            string text = @"""Hurry up, boy!"" shouted Uncle Vernon from the kitchen. ""What are you doing, checking for letter bombs?"" He chuckled at his own joke.
...
""Who'd be writing to you?"" sneered Uncle Vernon, shaking the letter open with one hand and glancing at it. His face went from red to green faster than a set of traffic lights. And it didn't stop there. Within seconds it was the grayish white of old porridge.";
            ...
            if (string.Compare(blabol3, prvni) < 0)
            {
                prvni = blabol3;
            }
            ...
            string veta = text.Substring(1, 13);
            ...
            {
                i = text.IndexOf(" and ", i, StringComparison.OrdinalIgnoreCase);
                if (i == -1)
                {
                    break;
                }

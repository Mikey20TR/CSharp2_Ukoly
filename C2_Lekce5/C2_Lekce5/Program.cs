...
namespace C2_Lekce5
{
    ...
    public class Program
    {
            ...
            List<int> ruznaCisla = new List<int>()
        {
            ...
            Console.WriteLine("Násobky 4 a 6:");
            ...
            Console.WriteLine($"Počet čísel v seznamu: {ruznaCisla.Count}");
            Console.WriteLine("");
            // ==========================================
            ...
            List<string> jmena = new List<string>()
        {
            ...
            // 4. Řešení
            foreach (string text in jmena.Order())
            {
            ...
            List<double> utrata = new List<double>()
        {
            ...
            Console.WriteLine($"Celkový součet útraty je {((decimal)utrata.Sum())}");
            Console.WriteLine("");
            // ==========================================		
            ...
            List<double> cena = new List<double>()
        {
            ...
            // 6. Řešení
            Console.WriteLine($"Největší cena je: {cena.Max()}");
            Console.WriteLine("");
            // ==========================================		
            ...
            skupinyPodleBanky = zakaznici.GroupBy(z => z.Banka);
